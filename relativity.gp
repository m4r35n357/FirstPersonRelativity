...
GNUTERM = "wxt"
plot 'debug.out' using 2:8 w l t 't', 'debug.out' using 2:10 w l t 'x', 'debug.out' using 2:4 w l t 'Home Clock', 'debug.out' using 2:6 w l t 'Away Clock', 'debug.out' using 2:14 w l t 'Clock 1', 'debug.out' using 2:16 w l t 'Clock 2', 'debug.out' using 2:18 w l t 'Clock 3', 'debug.out' using 2:20 w l t 'Clock 4', 'debug.out' using 2:22 w l t 'Clock 5', 'debug.out' using 2:24 w l t 'Clock 6', 'debug.out' using 2:26 w l t 'Clock 7', 'debug.out' using 2:28 w l t 'Clock 8', 'debug.out' using 2:30 w l t 'Clock 9'
#pause 10
#reread
#    EOF
